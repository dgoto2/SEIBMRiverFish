FUNCTION river1d_seibm_output_virtel, counter, VirTelReccount, SNSvirtel, TotDriftBio, EndDisChem, DensityDependence, Time, Rep

; Virtual telemetry study     
PRINT, 'VerTel OutputFiles BEGINS HERE'
...
; Set up variables.
OutputSNS1='EDC_'+EndDisChem+'_DD_'+DensityDependence+Time+'_Rep_'+Rep+'_IDLoutputVirTelSNS_1.csv'
filename1 = OutputSNS1
OutputSNS2='EDC_'+EndDisChem+'_DD_'+DensityDependence+Time+'_Rep_'+Rep+'_IDLoutputVirTelSNS_2.csv'
filename2 = OutputSNS2
OutputSNS3='EDC_'+EndDisChem+'_DD_'+DensityDependence+Time+'_Rep_'+Rep+'_IDLoutputVirTelSNS_3.csv'
filename3 = OutputSNS3
OutputSNS4='EDC_'+EndDisChem+'_DD_'+DensityDependence+Time+'_Rep_'+Rep+'_IDLoutputVirTelSNS_4.csv'
filename4 = OutputSNS4
OutputSNS5='EDC_'+EndDisChem+'_DD_'+DensityDependence+Time+'_Rep_'+Rep+'_IDLoutputVirTelSNS_5.csv'
filename5 = OutputSNS5
OutputSNS6='EDC_'+EndDisChem+'_DD_'+DensityDependence+Time+'_Rep_'+Rep+'_IDLoutputVirTelSNS_6.csv'
filename6 = OutputSNS6
OutputSNS7='EDC_'+EndDisChem+'_DD_'+DensityDependence+Time+'_Rep_'+Rep+'_IDLoutputVirTelSNS_7.csv'
filename7 = OutputSNS7
OutputSNS8='EDC_'+EndDisChem+'_DD_'+DensityDependence+Time+'_Rep_'+Rep+'_IDLoutputVirTelSNS_8.csv'
filename8 = OutputSNS8
OutputSNS9='EDC_'+EndDisChem+'_DD_'+DensityDependence+Time+'_Rep_'+Rep+'_IDLoutputVirTelSNS_9.csv'
filename9 = OutputSNS9
OutputSNS10='EDC_'+EndDisChem+'_DD_'+DensityDependence+Time+'_Rep_'+Rep+'_IDLoutputVirTelSNS_10.csv'
filename10 = OutputSNS10
OutputSNS11='EDC_'+EndDisChem+'_DD_'+DensityDependence+Time+'_Rep_'+Rep+'_IDLoutputVirTelSNS_11.csv'
filename11 = OutputSNS11
OutputSNS12='EDC_'+EndDisChem+'_DD_'+DensityDependence+Time+'_Rep_'+Rep+'_IDLoutputVirTelSNS_12.csv'
filename12 = OutputSNS12
OutputSNS13='EDC_'+EndDisChem+'_DD_'+DensityDependence+Time+'_Rep_'+Rep+'_IDLoutputVirTelSNS_13.csv'
filename13 = OutputSNS13
OutputSNS14='EDC_'+EndDisChem+'_DD_'+DensityDependence+Time+'_Rep_'+Rep+'_IDLoutputVirTelSNS_14.csv'
filename14 = OutputSNS14
OutputSNS15='EDC_'+EndDisChem+'_DD_'+DensityDependence+Time+'_Rep_'+Rep+'_IDLoutputVirTelSNS_15.csv'
filename15 = OutputSNS15
OutputSNS16='EDC_'+EndDisChem+'_DD_'+DensityDependence+Time+'_Rep_'+Rep+'_IDLoutputVirTelSNS_16.csv'
filename16 = OutputSNS16
OutputSNS17='EDC_'+EndDisChem+'_DD_'+DensityDependence+Time+'_Rep_'+Rep+'_IDLoutputVirTelSNS_17.csv'
filename17 = OutputSNS17
OutputSNS18='EDC_'+EndDisChem+'_DD_'+DensityDependence+Time+'_Rep_'+Rep+'_IDLoutputVirTelSNS_18.csv'
filename18 = OutputSNS18
OutputSNS19='EDC_'+EndDisChem+'_DD_'+DensityDependence+Time+'_Rep_'+Rep+'_IDLoutputVirTelSNS_19.csv'
...
;IF counter EQ 1L THEN pointer1 = VirTelReccount 
;IF counter EQ 21L THEN pointer2 = VirTelReccount 
;IF counter EQ 41L THEN pointer3 = VirTelReccount 
;IF counter EQ 61L THEN pointer4 = VirTelReccount 
;IF counter EQ 81L THEN pointer5 = VirTelReccount
;IF counter EQ 101L THEN pointer6 = VirTelReccount 
;IF counter EQ 121L THEN pointer7 = VirTelReccount 
;IF counter EQ 141L THEN pointer8 = VirTelReccount 
;IF counter EQ 161L THEN pointer9 = VirTelReccount
;IF counter EQ 181L THEN pointer10 = VirTelReccount 
;IF counter EQ 201L THEN pointer11 = VirTelReccount 
;IF counter EQ 221L THEN pointer12 = VirTelReccount 
;IF counter EQ 241L THEN pointer13 = VirTelReccount 
;IF counter EQ 261L THEN pointer14 = VirTelReccount 
;IF counter EQ 281L THEN pointer15 = VirTelReccount 
;IF counter EQ 301L THEN pointer16 = VirTelReccount 
;IF counter EQ 321L THEN pointer17 = VirTelReccount 
;IF counter EQ 341L THEN pointer18 = VirTelReccount 
;IF counter EQ 361L THEN pointer19 = VirTelReccount 

pointer1 = VirTelReccount * counter; 1st line to read in 
pointer2 = VirTelReccount * (counter - 20L)
pointer3 = VirTelReccount * (counter - 40L)
pointer4 = VirTelReccount * (counter - 60L)
pointer5 = VirTelReccount * (counter - 80L)
pointer6 = VirTelReccount * (counter - 100L)
pointer7 = VirTelReccount * (counter - 120L)
pointer8 = VirTelReccount * (counter - 140L)
pointer9 = VirTelReccount * (counter - 160L)
pointer10 = VirTelReccount * (counter - 180L)
pointer11 = VirTelReccount * (counter - 200L)
pointer12 = VirTelReccount * (counter - 220L)
pointer13 = VirTelReccount * (counter - 240L)
pointer14 = VirTelReccount * (counter - 260L)
pointer15 = VirTelReccount * (counter - 280L)
pointer16 = VirTelReccount * (counter - 300L)
pointer17 = VirTelReccount * (counter - 320L)
pointer18 = VirTelReccount * (counter - 340L)
pointer19 = VirTelReccount * (counter - 360L)
...
; Close the file.
Free_Lun, lun
PRINT, '"Your SNS VerTel Output File is Ready"'
