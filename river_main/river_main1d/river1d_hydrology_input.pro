...
; YEAR 1990
IF iYEAR EQ 1990L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput95.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
; YEAR 1991
IF iYEAR EQ 1991L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput95.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
; YEAR 1992
IF iYEAR EQ 1992L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput95.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
; YEAR 1993
IF iYEAR EQ 1993L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput95.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
; YEAR 1994
IF iYEAR EQ 1994L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput95.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')

; YEAR 1995
IF iYEAR EQ 1995L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput95.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
; YEAR 1996 
IF iYEAR EQ 1996L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput96.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
; YEAR 1997
IF iYEAR EQ 1997L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput97.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
; YEAR 1998
IF iYEAR EQ 1998L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput98.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
; YEAR 1999 
IF iYEAR EQ 1999L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput99.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
; YEAR 2000
IF iYEAR EQ 2000L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput00.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
; YEAR 2001
IF iYEAR EQ 2001L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput01.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
; YEAR 2002 
IF iYEAR EQ 2002L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput02.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
; YEAR 2003
IF iYEAR EQ 2003L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput03.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
; YEAR 2004
IF iYEAR EQ 2004L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput04.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
; YEAR 2005 
IF iYEAR EQ 2005L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput05.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
; YEAR 2006
IF iYEAR EQ 2006L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput06.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
; YEAR 2007
IF iYEAR EQ 2007L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput07.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
; YEAR 2008 
IF iYEAR EQ 2008L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput08.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
; YEAR 2009
IF iYEAR EQ 2009L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput09.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
; YEAR 2010
IF iYEAR EQ 2010L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput10.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
; YEAR 2011 
IF iYEAR EQ 2011L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput11.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')

IF iYEAR GE 2012L THEN BEGIN
  PRINT, 'INPUT YEAR FOR FORECASTING: ', RandInputYear2
  ; YEAR 1995
  IF RandInputYear2 EQ 1995L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput95.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
  ; YEAR 1996 
  IF RandInputYear2 EQ 1996L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput96.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
  ; YEAR 1997
  IF RandInputYear2 EQ 1997L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput97.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
  ; YEAR 1998
  IF RandInputYear2 EQ 1998L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput98.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
  ; YEAR 1999 
  IF RandInputYear2 EQ 1999L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput99.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
  ; YEAR 2000
  IF RandInputYear2 EQ 2000L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput00.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
  ; YEAR 2001
  IF RandInputYear2 EQ 2001L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput01.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
  ; YEAR 2002 
  IF RandInputYear2 EQ 2002L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput02.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
  ; YEAR 2003
  IF RandInputYear2 EQ 2003L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput03.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
  ; YEAR 2004
  IF RandInputYear2 EQ 2004L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput04.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
  ; YEAR 2005 
  IF RandInputYear2 EQ 2005L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput05.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
  ; YEAR 2006
  IF RandInputYear2 EQ 2006L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput06.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
  ; YEAR 2007
  IF RandInputYear2 EQ 2007L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput07.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
  ; YEAR 2008 
  IF RandInputYear2 EQ 2008L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput08.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
  ; YEAR 2009
  IF RandInputYear2 EQ 2009L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput09.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
  ; YEAR 2010
  IF RandInputYear2 EQ 2010L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput10.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
  ; YEAR 2011 
  IF RandInputYear2 EQ 2011L THEN file = FILEPATH('LowerPlatteRiverHydrologyInput11.csv', Root_dir = 'C:', SUBDIR = 'IDLWorkspace\river_main\lowerPlatteRiver_Input')
ENDIF
